...
public class AssessmentService {
	...
	public ByteArrayInputStream print(long id) {
		...
		List<AccessEntity> access = accessRepository.findByRoleIsNull();
		List<ReferenceEntity> refs = referenceRepository.findByType("CDRRMO Head");
		...
		try {
			...
			paragraph.setFont(new Font(FontFamily.HELVETICA, 9));
			
			final URL imageHeaderUrl = ResourceUtils.getURL("images/logo1.jpg");

			final URL imageHeaderUrl2 = ResourceUtils.getURL("images/logo2.png");

//			Image image = Image.getInstance(imageHeaderUrl);
//			image.scaleToFit(60, 60);
//			image.setAbsolutePosition(125, 710);
//			
//			Image image2 = Image.getInstance(imageHeaderUrl2);
//			image2.scaleToFit(60, 60);
//			image2.setAbsolutePosition(425, 710);
			
			Image image = Image.getInstance(imageHeaderUrl);
			image.scaleToFit(60, 60);
			image.setAbsolutePosition(125, 920);
			
			Image image2 = Image.getInstance(imageHeaderUrl2);
			image2.scaleToFit(60, 60);
			image2.setAbsolutePosition(425, 920);
			...
			paragraph.add(new Phrase("Republic of the Philippines", new Font(FontFamily.TIMES_ROMAN, 9, Font.NORMAL, new BaseColor(40, 53, 147))));
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new Phrase("City Government of Tagaytay", new Font(FontFamily.TIMES_ROMAN, 9, Font.NORMAL, new BaseColor(40, 53, 147))));
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new Phrase("Tagaytay City Risk Reduction and Management Council", new Font(FontFamily.TIMES_ROMAN, 9, Font.BOLD, new BaseColor(40, 53, 147))));
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new Phrase("1 Akle Street, City Hall Complex, Tagaytay City", new Font(FontFamily.TIMES_ROMAN, 9, Font.NORMAL, new BaseColor(40, 53, 147))));
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new Phrase("Hotline No. (046) 483-0446", new Font(FontFamily.TIMES_ROMAN, 9, Font.NORMAL, new BaseColor(40, 53, 147))));
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new LineSeparator());
			paragraph.add(Chunk.NEWLINE);
			paragraph.add(new Phrase("Initial Report", new Font(FontFamily.HELVETICA, 13, Font.BOLD)));
			paragraph.add(Chunk.NEWLINE);
			...
			mainDiv.addElement(new Chunk("A. Profile of the Event", new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("                    Type                      :          " + ass.getType(), new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("                    Source of Report :          Tagaytay City Disaster Risk Reduction Management Council", new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("                    Weather                :          " + ass.getWeather(), new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("B. Summary of Effects", new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("     1.    Areas Covered               :          " + ass.getBrgy(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     2.    Untowards Incident        :          " + ass.getIncident(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     3.    Population Affected", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           a.    Families                   :          " + ass.getFamiliesAffected(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           b.    Persons                   :          " + ass.getPersonsAffected(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           c.    Population displaced at the evacuation center (Pre-EVAC):          ", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("                   Families                 :          " + ass.getEvacuatedFamilies(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     4.    Casualties", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           a.    Dead                       :          " + ass.getDead(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           b.    Injured                    :          " + ass.getInjured(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           c.    Missing                   :          " + ass.getMissing(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     5.    Damaged Properties", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           a.    Houses", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("               a.a    Partially Damaged        :          " + ass.getPartiallyDamagedHouse(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("               a.b    Totally Damaged          :          " + ass.getTotallyDamagedHouse(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           b.    School Building                  :          " + ass.getDamagedSchool(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           c.    Hospital                             :          " + ass.getDamagedHospital(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           d.    Govt Offices                      :          " + ass.getDamagedGovtOffice(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           e.    Public Market                    :          " + ass.getDamagedMarket(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           f.    Other                                  :          " + ass.getOtherDamages(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     6.    Affected Lifelines", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           6.1.    Transporation Facilities", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("                 National Road                   :          " + ass.getAffectedNationalRoad(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("                 City Road                         :          " + ass.getAffectedCityRoad(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("                 Brgy Road                        :          " + ass.getAffectedBrgyRoad(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           6.2.    Communication Facilities   :          " + ass.getAffectedCommunication(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           6.3.    Power Interruption             :          " + ass.getPowerInterruption(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("           6.4.    Water Shortage                 :          " + ass.getWaterShortage(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk("     7.    Damage to Agricultural Products:          " + ass.getDamagedAgriculture(), new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			...
			mainDiv.addElement(new Chunk("Noted By", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
			mainDiv.addElement(new Chunk(refs.get(0).getValue(), new Font(FontFamily.HELVETICA, 9, Font.BOLD)));
			mainDiv.addElement(new Chunk("Head, TCDRRMO", new Font(FontFamily.HELVETICA, 9, Font.NORMAL)));
